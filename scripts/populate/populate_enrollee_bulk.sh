...
# populates a specified number of synthetic enrollees for the given portal/env/study

# populate_enrollee_bulk.sh ourhealth sandbox ourheart 10
...
curl -X POST -H "Authorization: Bearer $ACCESS_TOKEN" "$SERVER_NAME/api/internal/v1/populate/enrollee/$1/env/$2/study/$3/bulk?numEnrollees=$4"

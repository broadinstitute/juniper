...
# populate_enrollee.sh [portalShortcode] [studyShortcode] [envName]  [filePath from populate/src/main/resources/seed]
...
curl -X POST -H "Authorization: Bearer $ACCESS_TOKEN" "$SERVER_NAME/api/internal/v1/$1/studies/$2/env/$3/enrollee/populate?filePathName=$4&overwrite=true"

    ...
    <Modal.Body>
      <LoadingSpinner isLoading={isImageListLoading}>
        ...
        <BrandingOption label={'Site Favicon'}
          description={
            <span>The favicon for the participant website.
              Only <code>.ico</code> and <code>.png</code> files are supported as favicons.</span>
          }>
          <ImageSelector images={images.filter(i => /\.ico$|\.png$/.test(i.cleanFileName))}

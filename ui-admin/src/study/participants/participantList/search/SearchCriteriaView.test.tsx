...
import { FacetValue, SEX_FACET, StableIdStringArrayFacet } from '../../../../api/enrolleeSearch'
...
describe('SearchCriteriaView', () => {
  test('shows and deletes search criteria', async () => {
    ...
    const taskFacetValue = mockTaskFacetValue(facet as StableIdStringArrayFacet, 'COMPLETE')

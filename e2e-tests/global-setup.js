...
var runPopulatePortalScript = function () {
    return new Promise(function (resolve, reject) {
        exec('../scripts/populate_portal.sh demo', function (err, stdout, stderr) {
            if (err) {
 ...
 */
var globalSetup = function () { return __awaiter(void 0, void 0, void 0, function () {
    return __generator(this, function (_a) {
        switch (_a.label) {
            case 0:
                ...
                if (!process.env.CI) return [3 /*break*/, 2];
                return [4 /*yield*/, runPopulatePortalScript()];
            case 1:
                _a.sent();
                return [3 /*break*/, 3];
            case 2:

...
import { defaultSurvey, useI18n, useSurveyJSModel } from '@juniper/ui-core'
...
export default function RegistrationUnauthed({ registrationContext, returnTo }: {
  ...
  const { surveyModel, refreshSurvey } = useSurveyJSModel(registrationSurveyModel, null, onComplete, pager, portalEnv.environmentName)
